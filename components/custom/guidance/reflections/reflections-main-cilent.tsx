                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <div className="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                        ...
                        <Edit3 className="h-4 w-4 cursor-pointer" onClick={() => handleEdit(reflection.id)} />
                        <Share2 className="h-4 w-4 cursor-pointer" onClick={() => handleShare(reflection.id)} />
                        <Trash2 className="h-4 w-4 cursor-pointer" onClick={() => handleDelete(reflection.id)} />
                      </div>
                    </div>
                    ...
                    <p className="text-[#ebdbb2] leading-relaxed">{reflection.reflectionText}</p>
                  </CardContent>
                </Card>
              </motion.div>
            ))}
