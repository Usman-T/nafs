...
import { Moon, LayoutDashboard, Award, Calendar, BarChart3, Settings, User, Menu, X, LogOut } from "lucide-react"
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive ? "text-dark-orange-light" : "text-dark-fg2 hover:text-dark-orange-light",
              )}
            >
              <item.icon className="h-5 w-5" />
              <span>{item.name}</span>
        ...
        <div className="flex items-center justify-between">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" size="icon" className="rounded-full text-dark-fg1 hover:text-dark-fg0">
    ...
    <div className="flex min-h-screen bg-dark-bg0 bg-dark-pattern">
      ...
      <div className="flex flex-1 flex-col">
        <header className="sticky top-0 z-10 flex h-16 items-center border-b border-dark-bg2 bg-dark-bg0/80 px-6 backdrop-blur-md md:px-8 shadow-dark-glow">
          <Button variant="ghost" size="icon" className="mr-2 text-dark-fg1 md:hidden" onClick={() => setIsOpen(true)}>
